...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { suggestion: @suggestion.suggestion, user_name: @suggestion.user_name } }
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { suggestion: @suggestion.suggestion, user_name: @suggestion.user_name } }
