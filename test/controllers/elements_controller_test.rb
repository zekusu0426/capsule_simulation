...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post elements_url, params: { element: { name: @element.name, name_kana: @element.name_kana } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { name: @element.name, name_kana: @element.name_kana } }
